...
| File | Platform |
|------|----------|
| `01_facebook_ads.csv` | Facebook Ads |
| `02_google_ads.csv` | Google Ads |
| `03_tiktok_ads.csv` | TikTok Ads |
...
## Dashboard Preview
![Marketing Cross-Channel Performance Dashboard](dashboard.png)

---

## SQL Scripts
See `sql_script.sql` for the complete data transformation and KPI creation queries.
